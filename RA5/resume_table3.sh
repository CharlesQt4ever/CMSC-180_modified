#!/bin/bash
# Lab 05 — resume table3 sweep after a partial failure.
# Edit REMAINING with the (n t run) tuples that still need to run.
...
# EDIT THIS — list of "n t run" tuples that still need to be run.
REMAINING=(
...
echo "Resuming Lab 05 Table 3: $TOTAL runs remaining"
