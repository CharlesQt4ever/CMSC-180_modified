...
echo "Resuming Table 3 v2: $TOTAL runs remaining (just n=16000)"
...
wc -l "$CSV"
echo ""
echo "All 36 runs should now be done. Next: scp to lab PC:"
echo "  scp cpdelosreyes@10.0.9.134:~/lab04_table3.csv ."
